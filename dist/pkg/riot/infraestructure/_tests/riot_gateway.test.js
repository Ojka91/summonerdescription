...
const riot_gateway_1 = require("../riot_gateway");
/**
...
describe('RiotGateway', () => {
    const riotGateway = new riot_gateway_1.RiotGateway(axios_1.default, 'localhost', '1234');
    afterEach(() => {
        jest.resetAllMocks();
    });
    describe('getSummonerByName', () => {
        ...
        it('should return a Summoner object on successful API call', async () => {
            const expectedSummoner = { name: 'testSummoner', id: '', accountId: '', profileIconId: 2, puuid: '', revisionDate: 2, summonerLevel: 2 };
...
//# sourceMappingURL=riot_gateway.test.js.map